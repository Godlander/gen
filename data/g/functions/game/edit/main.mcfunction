...
execute if score showpath game matches 0 at @e[tag=spawn,tag=active] run summon marker ~ 7 ~ {Tags:["showpath","ground"],Rotation:[0f,-90f]}
execute if score showpath game matches 30 at @e[tag=spawn,tag=active] run summon marker ~ 7 ~ {Tags:["showpath","air"],Rotation:[0f,-90f]}
